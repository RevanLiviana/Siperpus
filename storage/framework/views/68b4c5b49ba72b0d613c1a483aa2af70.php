...
<head>
    ...
    <title>SiPerpus - <?php echo $__env->yieldContent('title', 'Sistem Informasi Perpustakaan'); ?></title>
    ...
    <div id="sidebar">
        ...
        <nav class="mt-2">
            ...
            <a href="<?php echo e(route('anggota.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('anggota.*') ? 'active' : ''); ?>">
                <i class="bi bi-people"></i> Anggota
            </a>
            <a href="<?php echo e(route('petugas.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('petugas.*') ? 'active' : ''); ?>">
                <i class="bi bi-person-badge"></i> Petugas
            </a>
            <a href="<?php echo e(route('buku.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('buku.*') ? 'active' : ''); ?>">
    ...
    <div id="main-content">
        ...
        <div id="topbar">
            ...
            <span class="topbar-user">
                ...
                <?php echo e(Auth::user()->name ?? Auth::user()->nama ?? 'Admin'); ?>
...
</html><?php /**PATH /Users/holykun/Documents/File PHP Laravel/belajar_php/siperpus/resources/views/layouts/app.blade.php ENDPATH**/ ?>