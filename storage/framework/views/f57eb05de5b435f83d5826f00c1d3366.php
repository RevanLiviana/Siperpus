...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('anggota.index')); ?>" class="text-muted text-decoration-none">Anggota</a></li>
                ...
                <form method="POST" action="<?php echo e(route('anggota.store')); ?>">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light" value="<?php echo e($noAnggota); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('nama_lengkap')); ?>" placeholder="Masukkan nama lengkap">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('email')); ?>" placeholder="contoh@email.com">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('no_telepon')); ?>" placeholder="08xxxxxxxxxx">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="tanggal_expire"
                                   class="form-control <?php $__errorArgs = ['tanggal_expire'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('tanggal_expire', date('Y-m-d', strtotime('+1 year')))); ?>">
                            <?php $__errorArgs = ['tanggal_expire'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="<?php echo e(route('anggota.index')); ?>" class="btn btn-outline-secondary rounded-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/holykun/Documents/File PHP Laravel/belajar_php/siperpus/resources/views/anggota/create.blade.php ENDPATH**/ ?>